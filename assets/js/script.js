...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Sudais Khalid";
...
var typed = new Typed(".typing-text", {
    strings: ["Gen Ai Engineer", "backend development", "web designing", "web development", "graphics designing"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function autoChangeSlides() {
  plusSlides(1);
  setTimeout(autoChangeSlides, 5000); // Change slide every 3 seconds
}

document.addEventListener('DOMContentLoaded', function() {
  setTimeout(autoChangeSlides, 3000); // Start auto-changing slides after 3 seconds
});
...
//       // You could also send this to a server API if needed
